...
const leadershipIcons = [Users, MessageSquare, Handshake, Award];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            Communication, coordination & growth
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Beyond technical skills — how I supported the team, communicated clearly, and grew as a team member.
          </p>
        </div>
